...
/**
 * Represents the different types of formatting that can be applied to a chat message.
 */
public enum TextFormatting
{
    ...
    {
        return friendlyName == null ? null : (TextFormatting)nameMapping.get(func_175745_c(friendlyName));
    }
    ...
    static {
        for (TextFormatting textformatting : values())
        {
            nameMapping.put(func_175745_c(textformatting.name), textformatting);
        }
    }
}
